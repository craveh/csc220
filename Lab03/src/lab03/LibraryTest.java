...
public class LibraryTest {
  ...
  public static void main(String[] args) {
	    ...
	    if (lib.lookup(978037429279L) == null)
		      System.out.println("TEST X FAILED -- empty library: lookup(isbn)");
...
//	    System.out.println(lib);
	    ...
	    if (!lib.checkout(9780330351690L, "Sam Smith", 1, 1, 2008))
		      System.out.println("TEST WORKED -- small library: checkout- book is already checked out by Jane Doe");
//	    lib.checkout(9780446580342L, "Jane Doe", 1, 7, 2008);
	    
	    booksCheckedOut = lib.lookup("Jane Doe");
	    for(int i = 0; i<booksCheckedOut.size(); i++) {
	    	System.out.println(booksCheckedOut.get(i));
	    }
